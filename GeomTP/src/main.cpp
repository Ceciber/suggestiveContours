...
struct Scene {
    ...
    void render()
  {
    ...
    glm::mat4 projMatrix = g_cam->computeProjectionMatrix();

    mainShader->set("camPos", cameraPosition);
    mainShader->set("viewMat", viewMatrix);
    mainShader->set("projMat", projMatrix);
